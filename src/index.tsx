...
import { GroupidsTestProps, GroupidsTest } from "./groupids-test";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/groupids-test.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <groupids-test message="world!"></groupids-test>
   */
  return class GroupidsTestBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): GroupidsTestProps {
      const attrs = this.parseAttributes<GroupidsTestProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<GroupidsTest {...this.props} widgetApi={_widgetApi} />);
    }
